const HomePage = () => {
  return (
    <div
      className="relative w-full sm:w-auto sm:p-10 h-[50vh] bg-gray-900 text-white flex items-center justify-center bg-cover bg-no-repeat bg-center p-4 sm:p-8 md:p-12"
      style={{
      ...
      <div className="absolute bottom-0 w-full opacity-80 bg-gray-800 text-white py-2">
        <div className="overflow-hidden whitespace-nowrap">
          <p className="animate-scroll text-sm sm:text-base md:text-lg">
            This is your scrolling text with smooth transitions. Make sure it’s
